...
function Notification() {
  ...
  return (
    <>
      <Tooltip title={t("view_notifications")} data-testId="Notification">
        <Button type="text" onClick={TriggerModal} className="cls-notificationBtn">
          <FdNotificationIcon  />
        </Button>
      </Tooltip>
      <Modal
        ...
        className="cls-modal"
        width={364}
        closeIcon={<Text className="cls-close-icon Infi-09_CloseIcon"></Text>}
        // ref={bottom_ref}
        footer={
          <>
            {/* <Divider plain />
