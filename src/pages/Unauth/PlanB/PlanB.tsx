...
const PlanB = () => {
  ...
  // const [, SsetFormData, SremoveFormData] = sessionStorageAccessor<any>("formData");
  const [, , SremoveSelectedFlights] = sessionStorageAccessor<any>("selectedFlights");
  const [, , SremoveReviewStatus] = sessionStorageAccessor<string>("reviewStatus");
  const [, , SremoveFinalViewPnrData] = sessionStorageAccessor<any>("finalViewPNRData");
  const [, , SremoveFinalReviewPnrData] = sessionStorageAccessor<any>("finalReviewPNRData");
  const [, , SremoveSsrPNRData] = sessionStorageAccessor<any>("ssrPNRData");
  const [, , SremoveSearchFlightPNRData] = sessionStorageAccessor<any>("searchFlightPNRData");
  const [, , SremoveFinalPaymentAmount] = sessionStorageAccessor<any>("finalPaymentAmount");
  const [, , SremoveSsrPrice] = sessionStorageAccessor<any>("ssrPrice");
  ...
  // const flightQueue = useGetPNRData("pnrQueue");
  ...
  return (
    <div data-testid="planB">
      ...
      <Row
        className={`cls-planB-container airline${SgetAirlineCode() ? SgetAirlineCode() : CFG.airline_code}`}
        align="middle"
      >
        <Col>
