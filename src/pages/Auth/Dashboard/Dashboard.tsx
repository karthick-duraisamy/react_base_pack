          ...
          <Row align="middle" justify="space-between" className="rg-5">
            <Col xs={24} sm={14} md={14} lg={14} xl={14}>
              <Flex className="f-med rg-0" wrap="wrap" align="center" gap="10px">
                <Text
                  className={`${isSmallScreen ? "fs-18 mb-5" : "fs-28"} f-sbold`}
                ...
                <Text
                  className="fs-15 Infi-79_Refresh cls-refresh-icon"
                  style={{
                    cursor: "pointer",
            ...
            <Col xs={11} sm={10} md={10} lg={9} xl={10} className="cls-sort cls-pnrSearch">
              <Row
                // gutter={[16, 16]}
                justify="end"
                className="cls-flex-flow mt-5 cls-calendar-filter "
              >
                ...
                <Card className="cls-pax-card">
                  <Row justify="space-between">
                    <Col span={15}>
                      ...
                      <Col className="mt-10 cls-affect-btn">
                        <UserOutlined />
                        <Text>
                          {t("affected")}{" "}
          ...
          <Row className="mb-15" gutter={[16, 16]}>
            ...
            >
              <Card className="cls-tabel-container">
                <Row className="mb-5 rg-5" justify="space-between" align="middle">
                  <Col>
                    <Title
                      level={5}
            ...
            <Col xs={24} md={24} lg={24} xl={9} className="cls-gap ">
              <Card className="cls-attention-gap">
                ...
                <Row className="cls-notification-header mt-5 mb-5">
                  <Col className=" fs-12" span={4}>
                    {t("flight_no")}
                  </Col>
                ...
                {notificatio_row_Data?.map((item: any, index: any) => (
                  <>
                    <Row className=" cls-notification-row">
                      ...
                      <Col className="fs-12 f-reg pb-5 cls-grey" xs={24} sm={15} md={15} lg={15} xl={15}>
              ...
              <Card>
                <Row className="cg-10">
                  ...
                  <Col xs={12} sm={4} md={5} lg={4} xl={3} className="a-self-center">
                    <span
                      className="mr-10 fs-12"
                      style={{ color: "var(--t-text-grey-light)" }}
                    >
                ...
                <Row className="cls-chart-header mt-10">
