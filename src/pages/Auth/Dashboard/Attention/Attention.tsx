      ...
      >
        <Col span={19}>
          ...
          <Row className="mt-5 cls-pnr-details">
            ...
            <Col span={9} className="fs-12 f-bold mt-5 pl-5 cls-attention-text">
              <p onClick={showDrawer}>
                {/* <Text className="Infi-08_User"></Text> */}
                {dataInfo.total_passenger}
                {dataInfo.pax_count}
              </p>
            </Col>
            <Col span={3} className="fs-12 f-sbold mt-5 cls-attention-tablePnr"  style={{color:'#1576C0'}}>
              <p>
                {dataInfo.info}
              </p>
            </Col>
        ...
        <Col span={4} className="cls-btn-container">
          <Button
            ...
            // onClick={handleClick}
          >
            <Text className="Infi-08_User mt-50" style={{color:'#fff'}}></Text>
