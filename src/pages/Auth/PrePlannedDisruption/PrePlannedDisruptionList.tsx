...
const PrePlannedDisruptionList: React.FC = () => { 
  ...
  const [_isModalOpen, toggleModal] = useToggle(false);
  const [, , _SremoveAdhocFlightPNRs] =
    sessionStorageAccessor<any>("adhocFlightPNRs");
  const { isCurrentPathEqual } = useRedirect();
  // const [, , SremoveFormData] = sessionStorageAccessor<any>("formData");
                    ...
                    <Row justify="center" align="middle">
                      ...
                      <Col>
                        <Button
                          onClick={() => toggleModal()}
                          type="primary"
                          className="cls-primary-btn-inverted f-med mt-15 px-20 py-10 fs-18"
                        >
                          {t("sync_pnr")}
                        </Button>
                      </Col>
